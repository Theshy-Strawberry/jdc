 ...
 */
/**
 * @ngdoc function pos机终端管理
 * @name codeApp.controller:posInfoCTRL
 * @description
 * # posInfoCTRL
...
define([
        ...
        controllers.controller('posInfoCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                baseService.actionName.name="posInfo";
                ...
                //查询所有信息
                baseService.post("/posInfo/getUserAll", {}).then(
                    function(data){
                ...
                /*保存或更改*/
                $scope.save=function(){
                    if(angular.isUndefined($scope.user_form.pos_code.$modelValue)){
                        $scope.user_form.pos_code.$touched = "true";
                        return;
                    }
