 ...
 */
/**
 * @ngdoc function 成交途径类型管理
 * @name codeApp.controller:dealWayCTRL
 * @description
 * # dealWayCTRL
...
define([
        ...
        controllers.controller('dealWayCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                baseService.actionName.name="dealWay";
                ...
                //查询所有信息
                baseService.post("/dealWay/getUserAll", {}).then(
                    function(data){
