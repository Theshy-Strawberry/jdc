 ...
 */
/**
 * @ngdoc function 佣金类型管理
 * @name codeApp.controller:BrokerageTypeCTRL
 * @description
 * # BrokerageTypeCTRL
...
define([
        ...
        controllers.controller('brokerageTypeCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                //访问后台的路径名
                baseService.actionName.name="brokerageType";
                ...
                baseService.gridOptions.columnDefs = [
                    ...
                    //{name: 'create_user', displayName: '创建人', minWidth: 120,headerCellClass:'headerCss',cellTooltip: true,cellFilter: 'userFilter:grid.options.userIds'},
                    //,cellTemplate: '<div style="text-align: center;">{{row.entity.create_user}}</div>'},
                    {name: 'create_date', displayName: '创建时间', minWidth: 120,headerCellClass:'headerCss',cellClass:'cellCss'},
                    //, cellTemplate: '<div style="text-align: center;">{{row.entity.create_date | date:"yyyy-MM-dd hh:mm:ss"}}</div>' },
                    //{name: 'create_user', displayName: '创建人', minWidth: 120,headerCellClass:'headerCss'},
                    {
