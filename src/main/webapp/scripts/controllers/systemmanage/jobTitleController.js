...
define([
        ...
        controllers.controller('jobTitleCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                //访问后台的路径名
                baseService.actionName.name="jobTitle";
                ...
                //查询所有信息
                baseService.post("/jobTitle/getUserAll", {}).then(
                    function(data){
                ...
                $scope.save=function(){
                    //判断验证是否通过
                    if (angular.isUndefined($scope.user_form.title_name.$modelValue)){
                        $scope.user_form.title_name.$touched = "true";
                        return;
                    }
                    //else {
