...
*/
/**
 * @ngdoc function 产品类型管理
 * @name codeApp.controller:productTypeCTRL
 * @description
 * # productTypeCTRL
...
define([
        ...
        controllers.controller('productTypeCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                baseService.actionName.name="productType";
                ...
                $scope.toggleRight=function(){
                    ...
                    baseService.getCurUser().then(
                        function(data){
                            ...
                            //$scope.obj.object.user_name=data.session.userSession.user_name;
                        }
                    );
                    $scope.openRight();
               ...
               // 查询所有信息
                baseService.post("/productType/getUserAll", {}).then(
                    function(data){
                ...
                /*保存或更改*/
                $scope.save=function(){
                    if(angular.isUndefined($scope.user_form.type_name.$modelValue)){
                        $scope.user_form.type_name.$touched = "true";
                        return;
                    }
                ...
                baseService.gridOptions.columnDefs = [
                    ...
                    {name: 'create_user', displayName: '创建人', minWidth: 250,headerCellClass:'headerCss',cellTooltip: true,cellFilter: 'userFilter:grid.options.userIds'},
                    {
