 ...
 */
/**
 * @ngdoc function 科目支出管理
 * @name codeApp.controller:paySubjectCTRL
 * @description
 * # paySubjectCTRL
...
define([
        ...
        controllers.controller('paySubjectCTRL',[
            '$scope',
            '$mdSidenav',
            '$timeout',
            '$mdDialog',
            ...
            function($scope, $mdSidenav, $timeout, $mdDialog, menu, $location, $rootScope, $mdUtil, $log, $http, $filter, uiGridConstants, baseService, $q, $mdToast, i18nService,selectData){
                ...
                baseService.actionName.name="paySubject";
                ...
                //查询所有信息
                baseService.post("/paySubject/getUserAll", {}).then(
                    function(data){
                ...
                /*保存或更改*/
                $scope.save=function(){
                    if(angular.isUndefined($scope.user_form.subject_name.$modelValue)){
                        $scope.user_form.subject_name.$touched = "true";
                        return;
                    }
