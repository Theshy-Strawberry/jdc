...
public class ConfigKit {
    ...
    private static Map<String, String> map = CFKit.newMap();

    private static Map<String, String> devMap = CFKit.newMap();
    private static Map<String, String> testMap = CFKit.newMap();

    private static Map<String, Long> lastmodifies = CFKit.newMap();
     ...
     * @param reload
     */
    public static void init(List<String> includeResources, List<String> excludeResources, boolean reload) {
        ...
        for (final String resource : includeResources) {
            ...
            for (File file : propertiesFiles) {
                ...
                if (fileName.endsWith("-dev." + ConfigPlugin.suffix)) {
                    continue;
                }
                ...
                try {
                    devMap.putAll(ResourceKit.readProperties(devFileName(fileName)));
    ...
    private static String devFileName(String fileName) {
        return fileName.substring(0, fileName.indexOf("." + ConfigPlugin.suffix)) + "-dev." + ConfigPlugin.suffix;
    }
