...
public class ClassSearchKit {
	...
	private static List<String> findFiles(String baseDirName,
		 ...
		 */
		List<String> classFiles = CFKit.newList();
	...
	private List<String> includeJars = CFKit.newList();
	...
	public ClassSearchKit injars(List<String> jars) {
		if (jars != null) {
	...
	public ClassSearchKit inJars(String... jars) {
		if (jars != null) {
			for (String jar : jars) {
				includeJars.add(jar);
			}
	...
	public ClassSearchKit classpath(String classpath) {
	...
	public <T> List<Class<? extends T>> search() {
		List<String> classFileList = CFKit.newList();
		if (scanPackages.isEmpty()) {
			classFileList = findFiles(classpath, "*.class");
		} else {
			for (String scanPackage : scanPackages) {
				classFileList.addAll(findFiles(classpath + File.separator
	 ...
	 * @param includeJars
	 *
	 * @see <a href="http://my.oschina.net/u/556800" target="_blank"
	...
	public ClassSearchKit includeAllJarsInLib(boolean includeAllJarsInLib) {
		this.includeAllJarsInLib = includeAllJarsInLib;
		return this;
	}

	public ClassSearchKit libDir(String libDir) {
		this.libDir = libDir;
		return this;
	}

	public ClassSearchKit scanPackages(List<String> scanPaths) {
		if (scanPaths != null) {
